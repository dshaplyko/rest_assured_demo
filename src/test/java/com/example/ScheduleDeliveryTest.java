...
public class ScheduleDeliveryTest {
    ...
    public void testScheduleDelivery() throws IOException {
        ...
        Assert.assertTrue(deliveryFee > 0, "deliveryFee should be greater than 0");

        Integer driverTip = response.path("driverTip");
        Assert.assertNotNull(driverTip, "driverTip is null");
        Assert.assertTrue(driverTip > 0, "driverTip should be greater than 0");
    ...
    @Test
    public void testScheduleDeliveryInvalid() throws IOException {
        String requestBody = readFileAsString("request/ScheduleDeliveryRequestInvalid.json");
